...
```
wget https://github.com/ROCm-Developer-Tools/aomp/releases/download/rel_0.7-2/aomp_Ubuntu1804_0.7-2_amd64.deb
sudo dpkg -i aomp_Ubuntu1804_0.7-2_amd64.deb
```
On Ubuntu 16.04,  run these commands:
```
wget https://github.com/ROCm-Developer-Tools/aomp/releases/download/rel_0.7-2/aomp_Ubuntu1604_0.7-2_amd64.deb
sudo dpkg -i aomp_Ubuntu1604_0.7-2_amd64.deb
```
...
```
   wget https://github.com/ROCm-Developer-Tools/aomp/releases/download/rel_0.7-2/aomp_Ubuntu1804_0.7-2_amd64.deb
   dpkg -x aomp_Ubuntu1804_0.7-2_amd64.deb /tmp/temproot
```
On Ubuntu 16.04:
```
   wget https://github.com/ROCm-Developer-Tools/aomp/releases/download/rel_0.7-2/aomp_Ubuntu1604_0.7-2_amd64.deb
   dpkg -x aomp_Ubuntu1604_0.7-2_amd64.deb /tmp/temproot
```
```
