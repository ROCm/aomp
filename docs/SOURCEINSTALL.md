...
These commands will build a previous release of AOMP such as aomp-21.0-0.<br>
<b>Release Branch:</b>
```
   export AOMP_VERSION=21.0
   export AOMP_REPOS=$HOME/git/aomp${AOMP_VERSION}
   mkdir -p $AOMP_REPOS
   cd $AOMP_REPOS
   git clone -b aomp-21.0-0 https://github.com/ROCm-Developer-Tools/aomp
```
<b>Clone and build:</b>
```
