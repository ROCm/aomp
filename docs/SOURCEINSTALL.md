...
2. Build CMake 3.18.5 from source. This can be done with ./build_prereq.sh,
...
These commands will build a previous release of AOMP such as aomp-16.0-1.<br>
<b>Release Branch:</b>
```
   export AOMP_VERSION=16.0
   export AOMP_REPOS=$HOME/git/aomp${AOMP_VERSION}
   mkdir -p $AOMP_REPOS
   cd $AOMP_REPOS
   git clone -b aomp-16.0-1 https://github.com/ROCm-Developer-Tools/aomp
```
<b>Clone and build:</b>
```
...
MANIFEST FILE: ~/git/aomp16.0/aomp/bin/../manifests/aomp_16.0-1.xml
```
