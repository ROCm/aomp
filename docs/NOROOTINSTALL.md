...
```
   ...
   dpkg -x aomp_Ubuntu2004_16.0-1_amd64.deb /tmp/temproot
```
...
```
   ...
   dpkg -x aomp_Ubuntu1804_16.0-1_amd64.deb /tmp/temproot
```
...
For SLES15-SP1:
```
   wget https://github.com/ROCm-Developer-Tools/aomp/releases/download/rel_16.0-1/aomp_SLES15_SP1-16.0-1.x86_64.rpm
   rpm2cpio aomp_SLES15_SP1-16.0-1.x86_64.rpm | cpio -idmv
```
For CentOS/RHEL 7:
```
   wget https://github.com/ROCm-Developer-Tools/aomp/releases/download/rel_16.0-1/aomp_CENTOS_7-16.0-1.x86_64.rpm
   rpm2cpio aomp_CENTOS_7-16.0-1.x86_64.rpm | cpio -idmv
```
For CentOS 8:
```
   wget https://github.com/ROCm-Developer-Tools/aomp/releases/download/rel_16.0-1/aomp_CENTOS_8-16.0-1.x86_64.rpm
   rpm2cpio aomp_CENTOS_8-16.0-1.x86_64.rpm | cpio -idmv
```
Move to $HOME and set variables:
```
   mv /tmp/temproot/usr $HOME
