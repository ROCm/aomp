...
```
   ...
   dpkg -x aomp_Ubuntu1804_11.7-0_amd64.deb /tmp/temproot
```
...
For Red Hat:
```
   wget https://github.com/ROCm-Developer-Tools/aomp/releases/download/rel_11.7-0/aomp_REDHAT_7-11.7-0.x86_64.rpm
   rpm2cpio aomp_REDHAT_7-11.7-0.x86_64.rpm | cpio -idmv
```
For SLES15-SP1:
```
   wget https://github.com/ROCm-Developer-Tools/aomp/releases/download/rel_11.7-0/aomp_SLES15_SP1-11.7-0.x86_64.rpm
   rpm2cpio aomp_SLES15_SP1-11.7-0.x86_64.rpm | cpio -idmv
```
Move to $HOME and set variables:
```
   mv /tmp/temproot/usr $HOME
