...
The build_aomp.sh script will install into $HOME/rocm/aomp_21.0-1 and create a symbolic link from $HOME/rocm/aomp to $HOME/rocm/aomp_21.0-1.
This feature allows multiple versions of AOMP to be installed concurrently.
To enable a backlevel version of AOMP, simply set AOMP to $HOME/rocm/aomp_21.0-0.
