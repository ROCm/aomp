...
sudo rpm -i aomp_REDHAT_9-22.0-0.x86_64.rpm

wget https://github.com/ROCm-Developer-Tools/aomp/releases/download/rel_22.0-0/aomp-hip-libraries_REDHAT_9-22.0-0.x86_64.rpm
sudo rpm -i aomp-hip-libraries_REDHAT_9-22.0-0.x86_64.rpm
```
...
sudo rpm -i aomp_REDHAT_8-22.0-0.x86_64.rpm

wget https://github.com/ROCm-Developer-Tools/aomp/releases/download/rel_22.0-0/aomp-hip-libraries_REDHAT_8-22.0-0.x86_64.rpm
sudo rpm -i aomp-hip-libraries_REDHAT_8-22.0-0.x86_64.rpm
```
