/*
 * Test showing that the tool initializer must return the correct status for
  ...
  ompt_data_t *tool_data)
{
  ...
  if (!ompt_set_callback) return 1; // failed, should return 0 though
  ...
  return 0; //success, should return 1 according to OMPT spec
}
