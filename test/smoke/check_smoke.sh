...
known_fails="targ_static target_teams_reduction tasks simple_ctor flang_red_swdev-273281 math_exp flang-272730-complex flang_dev_write flang-272343 flang-274773"
