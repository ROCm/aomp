...
void __kmpc_xteamr_sum_d_4x64(double, double *, double *,  unsigned int *);
void __kmpc_xteamr_sum_f_4x64(float, float *, float *,  unsigned int *);
void __kmpc_xteamr_sum_i_4x64(int, int *, int *,  unsigned int *);
void __kmpc_xteamr_sum_ui_4x64(unsigned int, unsigned int *, unsigned int *,  unsigned int *);
void __kmpc_xteamr_sum_l_4x64(long int, long int *, long int *,  unsigned int *);
void __kmpc_xteamr_sum_ul_4x64(unsigned long , unsigned long *, unsigned long *,  unsigned int *);
void __kmpc_xteamr_max_d_4x64(double, double *, double *,  unsigned int *);
void __kmpc_xteamr_max_f_4x64(float, float *, float *,  unsigned int *);
void __kmpc_xteamr_max_i_4x64(int, int *, int *,  unsigned int *);
void __kmpc_xteamr_max_ui_4x64(unsigned int, unsigned int *, unsigned int *,  unsigned int *);
void __kmpc_xteamr_max_l_4x64(long int, long int *, long int *,  unsigned int *);
void __kmpc_xteamr_max_ul_4x64(unsigned long , unsigned long *, unsigned long *,  unsigned int *);
void __kmpc_xteamr_min_d_4x64(double, double *, double *,  unsigned int *);
void __kmpc_xteamr_min_f_4x64(float, float *, float *,  unsigned int *);
void __kmpc_xteamr_min_i_4x64(int, int *, int *,  unsigned int *);
void __kmpc_xteamr_min_ui_4x64(unsigned int, unsigned int *, unsigned int *,  unsigned int *);
void __kmpc_xteamr_min_l_4x64(long int, long int *, long int *,  unsigned int *);
void __kmpc_xteamr_min_ul_4x64(unsigned long , unsigned long *, unsigned long *,  unsigned int *);
...
void __kmpc_xteamr_sum_d_4x64(double val, double * pval, double * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_sum_f_4x64(float val, float * pval, float * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_sum_i_4x64(int val, int * pval, int * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_sum_ui_4x64(unsigned int val, unsigned int *pval, unsigned int * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_sum_l_4x64(long int val, long int * pval, long int * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_sum_ul_4x64(unsigned long val, unsigned long * pval, unsigned long * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_max_d_4x64(double val, double * pval , double * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_max_f_4x64(float val, float * pval, float * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_max_i_4x64(int val, int * pval, int * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_max_ui_4x64(unsigned int val, unsigned int * pval, unsigned int * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_max_l_4x64(long int val, long int * pval, long int * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_max_ul_4x64(unsigned long val, unsigned long * pval, unsigned long * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_min_d_4x64(double val, double * pval, double * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_min_f_4x64(float val, float * pval, float * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_min_i_4x64(int val, int * pval, int * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_min_ui_4x64(unsigned int val, unsigned int * pval, unsigned int * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_min_l_4x64(long int val, long int * pval, long int * xteam_mem, unsigned int * ptr)
  { *pval = val;}
void __kmpc_xteamr_min_ul_4x64(unsigned long val, unsigned long * pval, unsigned long int * xteam_mem, unsigned int * ptr)
  { *pval = val;}
#endif
}
