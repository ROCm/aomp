/*
 * Test showing that if both regular and EMI callbacks are registered for
 * the same event, only the EMI callback will be invoked. The registration
 * call does not return any error
 */
