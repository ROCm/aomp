...
NOINLINE __device__ void TestFunction(int *d_ptr, __shared__ int *lds_ptr) {
...
/// CHECK-NEXT:  #0 [[PC]] in TestFunction(int*, int*) at {{.*}}/aomp/test/smoke-asan/hip-function-parameters-lbo/hip-function-parameters-lbo.cpp:18:{{[0-9]+}}
