...
!!$acc declare create(fftblock,fftblockpad)
!$omp declare target to(fftblock,fftblockpad)
...
!!$acc declare create(u0, u1, twiddle)
!$omp declare target to(u0, u1, twiddle,y1,y2)
...
!---------------------------------------------------------------------
      ...
      use ft_data, only : ntotalp,maxdim
      use ft_fields
