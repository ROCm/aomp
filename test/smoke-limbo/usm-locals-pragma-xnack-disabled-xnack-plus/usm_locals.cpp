...
// usm_locals: XNACK disabled, compiled with: gfxXXX:xnack+, with USM pragma => OUTCOME: MISMATCH
...
int main() {
  ...
  /// CHECK: AMDGPU error: Image is not compatible with current XNACK mode! XNACK is disabled on the system. However, the image requires xnack+.
