...
! Note that the v6 compiler on an R8000 does something stupid with
! the above. Using the following instead (or various other things)
! makes the calculation run almost 10 times as fast. 
! 
!      save d2m46
!      data d2m46/0.0d0/
!      if (d2m46 .eq. 0.0d0) then
!         d2m46 = 0.5d0**46
!      endif
