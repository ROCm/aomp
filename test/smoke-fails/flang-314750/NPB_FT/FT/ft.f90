...
!            call cfftz (is, logd1, d1, y1, y2)
      do l = 1, logd1, 2
        call fftz2 (is, l, logd1, d1, fftblock, fftblockpad, u, y1, y2)
        if (l .eq. logd1) goto 160
        call fftz2 (is, l + 1, logd1, d1, fftblock, fftblockpad, u, y2, y1)
      enddo
...
!$omp declare target (x,xout,y1,y2,u)
      integer i, j, k, ii, in
...
!           call cfftz (is, logd2, d2, y1, y2)
      do l = 1, logd2, 2
        call fftz2 (is, l, logd2, d2, fftblock, fftblockpad, u, y1, y2)
        if (l .eq. logd2) goto 161
        call fftz2 (is, l + 1, logd2, d2, fftblock, fftblockpad, u, y2, y1)
      enddo
...
!$omp declare target to(fftz2)
      ...
      integer is, d1, d2, d3, logd3, l
      double complex x(d1+1,d2,d3)
      double complex xout(d1+1,d2,d3)
      double complex y1(fftblockpad, d3), y2(fftblockpad, d3)
!$omp declare target (x,xout,y1,y2)
      integer i, j, k, ii, in,i1,j1
...
!           call cfftz (is, logd3, d3, y1, y2)
      do l = 1, logd3, 2
        call fftz2 (is, l, logd3, d3, fftblock, fftblockpad, u, y1, y2)
        if (l .eq. logd3) goto 162
        call fftz2 (is, l + 1, logd3, d3, fftblock, fftblockpad, u, y2, y1)
      enddo
