...
-DLLVM_LIT_ARGS=-v \
-DLLVM_DIR=$BUILD_TRUNK/build/$LLVMPROJECT/lib/cmake/llvm \
-DCLANG_DIR=$BUILD_TRUNK/build/$LLVMPROJECT/lib/cmake/clang \
-DMLIR_DIR=$BUILD_TRUNK/build/$LLVMPROJECT/lib/cmake/mlir \
