#!/bin/bash
#
# pt2_no_teams.sh : Compare c and fortran versions of a test of parallel do (no teams)
#
...
#
# pt2_no_teams.sh is identical to parallel_no_teams.sh except pt2_no_teams.sh
