...
if [ "$1" != "nocmake" ] && [ "$1" != "install" ] ; then 
   ...
   MYCMAKEOPTS="-DCMAKE_INSTALL_PREFIX=$INSTALL_ROCM -DCMAKE_BUILD_TYPE=$BUILDTYPE -DCMAKE_PREFIX_PATH=$ROCM_DIR -DIMAGE_SUPPORT=OFF $AOMP_ORIGIN_RPATH -DCMAKE_C_COMPILER=${LLVM_INSTALL_LOC}/bin/clang -DCMAKE_CXX_COMPILER=${LLVM_INSTALL_LOC}/bin/clang++"
