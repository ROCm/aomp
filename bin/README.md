...
For example, when building AOMP version 15.0-0 the install scripts will put all files and directories
in $HOME/rocm/aomp_15.0-0 and create a symbolic link as follows:
