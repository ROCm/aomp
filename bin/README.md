...
| AOMP_VERSION_MOD      | 1                  | This implies the next release will be AOMP_17.0-1.
...
AOMP=$HOME/rocm/aomp_16.0-3.  Be careful that if you set AOMP for testing purposes that
