...
| AOMP_VERSION_MOD      | 2                  | This implies the next release will be AOMP_14.0-2.
...
For example, when building AOMP version 14.0-1 the install scripts will put all files and directories
in $HOME/rocm/aomp_14.0-1 and create a symbolic link as follows:

```
ln -sf ${AOMP}_14.0-1 ${AOMP}
```
...
For example, if the aomp symbolic link currently points to aomp_14.0-1 and you want to test aomp_14.0-0, do this:

```
export AOMP=$HOME/rocm/aomp_14.0-0
```
