...
-DCMAKE_Fortran_COMPILER=$OUT_DIR/llvm/bin/clang \
-DLLVM_TARGETS_TO_BUILD=$TARGETS_TO_BUILD \
-DLLVM_INSTALL_RUNTIME=ON \
-DFLANG_BUILD_RUNTIME=ON \
-DOPENMP_BUILD_DIR=$OUT_DIR/build/aomp/build/openmp/runtime/src
-DCMAKE_PREFIX_PATH=$OUT_DIR/build/aomp/build/pgmath"
